...
$sql = "SELECT * FROM topic WHERE topic_section_id=2";

$result_topic = $db->query($sql);
$topic = $result_topic->fetchAll(PDO::FETCH_ASSOC);

$sql2 = "SELECT * FROM section WHERE section_id=2";
...
load('General', '../templates/general/general_section.html', compact('btn_edit','btn_delet','result','msg','view','themes_len','section_name'));
